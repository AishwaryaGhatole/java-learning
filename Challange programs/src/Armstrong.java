...
public class Armstrong {
  ...
  public static boolean isArmstrong(int num){ //153
    ...
    int finalNumber = 0;
    while(num > 0){  //153>0=true || 15>0=true || 1 ||
      int digit = num % 10; //153%10=3 || 15%10=5 1%10=1
      num=num / 10; //153/10=15 || 15/10 = 1 || 1/10=0
      finalNumber = finalNumber + powerCalculator(digit, totalDigit); //0+powerCalculator(3,3)=27 || 27+powerCalculator(5,3) 
  ...
  public static int powerCalculator(int num1, int num2){ //int 2, int 3
    ...
    while(num2 > i){  //3>0=true || 3>1=true || 3>2=true || 3>3=false (End, Return result = 1*2*2*2)
      result = result * num1; // 1*2 || 1*2*2 || 1*2*2*2
      i++; //1 || 2 || 3
    }
  ...
  public static int noOfDigit(int num){  // int 153
    ...
    while(num > 0){ //153 > 0=true || 15>0=true || 1>0=true || 0>0=false (End, hence return digit=3)
      num = num / 10; //153 = 150/10=15 || 15/10=1 || 1/10=0
      digit ++; // 1 || 2 || 3
    }
